  ...
  return (
    <section className="mt-28 md:mt-36 mx-auto max-w-6xl px-4 font-montserrat">
      ...
      <div className="bg-white rounded-lg border shadow-sm">
        <div className="hidden md:grid grid-cols-12 gap-4 px-5 py-3 text-xs font-semibold text-second-text border-b">
        ...
        {cart.length === 0 ? (
          ...
          cart.map((item) => (
            <div
              key={item.product?.id}
              className="grid grid-cols-12 gap-4 px-5 py-4 items-center border-b last:border-b-0"
            >
